...
#SBATCH --output=/no_backup/rg/ileahy/logs/nf_Giardia_duodenalis_%A.out   # log per job
#SBATCH --error=/no_backup/rg/ileahy/logs/nf_Giardia_duodenalis_%A.err   # error log
