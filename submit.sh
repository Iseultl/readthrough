...
nextflow run main_mammal.nf -stub-run --species_taxid 10020 --species_name test_species --max_cpus 1 --max_memory '8GB' -work /nfs/scratch01/rg/ileahy/ -profile cluster
