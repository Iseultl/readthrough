...
#SBATCH --output=/no_backup/rg/ileahy/logs/nf_orfsearch_pvivax_%A.out  # log per job
#SBATCH --error=/no_backup/rg/ileahy/logs/nf_orfsearch_pvivax_%A.err   # error log
